...
router.get('/', async function(req, res) {
    ...
    serviceKey = "33EZ3dkLWYrPnfmRjyYyrzWIHQpJ7D2HQKpymFIw%2BleLzzU%2BHItw93aoiyjZJmahBSsN%2Frsq53VJ%2FaHpaG7xyg%3D%3D";
    ...
    try {
        var context = new Array();
				//axios로 HTTP GET 요청 // 비동기 방식 : 여러명이 요청하면 응답효율 x
